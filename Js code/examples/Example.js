...
windows.active.push(new Window(41,41,60,40,"Small window!",function(){cls(11);spr(32+(t/3|0)%8,10,15)},5))
windows.active.push(new Window(55,70,100,20,"Wide window",function(){
var i=0,x=windows.active[i],m=windows.tr.m()
if(this.x==0&&this.y==0){this.title=this.w+";"+this.h+":"+this.x+";"+this.y}
cls()
print("hitbox:"+windows.ii(m[0],m[1],x.x,x.y,x.w,x.h)+"\n collides?:"+windows.co(m[0],m[1],i)+" shown?:"+!(i==-1),0,0,12)},3))
windows.active.push(new Window(100,55,40,70,"Longer text to test the title bar handling long texts",function(){
cls(5)
var i
for(i=0;i<200;i+=0.5){
 circ(this.w/2+i*Math.cos((this.t+i)/10),this.h/2+i*Math.sin((this.t+i)/10),6,4)
}
//Demo rewritten from Nbrther1607's project
}))
